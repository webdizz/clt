...
public class Windows {
	 ...
	 * 
	 * @param url
	 *            the initial url of the first tab in the window
	 * @param left
	 *            the distance from the left of the screen in pixels of the top
	 *            left corner of the new window
	 * @param top
	 *            the distance from the top of the screen in pixels of the top
	 *            left corner of the new window
	 * @param width
